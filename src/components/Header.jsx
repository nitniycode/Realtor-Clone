        ...
        <header className='flex justify-between items-center px-5 max-w-6xl mx-auto'>
            ...
            <div>
                <ul className='flex space-x-6'>
                    ...
                    <li
                      className={`cursor-pointer py-3 text-gray-400 text-sm font-semibold border-b-[3px] border-b-transparent ${(matchRoute('/sign-in') || matchRoute('/profile')) && 'text-black border-b-red-600'}
                      `}
